...
void myproject_in(
    ...
    #pragma HLS STREAM variable=layer7_out depth=118 dim=1
    ...
    #pragma HLS STREAM variable=layer8_out depth=118 dim=1
    ...
    while(!layer51_out[0].empty()) nnet::dense_large_stream<layer51_t, layer52_t, config52>(layer51_out, layer52_out, w52, b52);
